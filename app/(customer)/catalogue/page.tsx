...
export default async function CataloguePage() {
  ...
  const styles = [...new Set(frames.map(f => f.style))].filter(Boolean)
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 pt-4">
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="font-display font-black text-2xl gradient-text">Frame Catalogue</h1>
          </div>
        ...
        {frames.length > 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-text-muted font-mono text-sm">No frames added yet</p>
            <p className="text-text-muted/60 text-xs mt-1">Visit Admin → Frames to upload inventory</p>
          </div>
        )}
      </div>
    </div>
